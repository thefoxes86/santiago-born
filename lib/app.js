                  ...
                  .then(function () {
                    s.start(function (e) {
                      var i = e.do.gamma,
                        a = e.do.beta
                      ;(t.mouseTargetY =
                        m(a, -t.maxTilt, t.maxTilt) / t.maxTilt),
                        (t.mouseTargetX =
        ...
        GyroNorm: (function () {
          ...
          return (
            ...
            (E.prototype.init = function (t) {
              ...
              var e = new FULLTILT.getDeviceOrientation({ type: y }).then(
                  function (t) {
                    v = t
                  }
                ),
                i = new FULLTILT.getDeviceMotion().then(function (t) {
                  u =
                    (g = t).getScreenAdjustedAccelerationIncludingGravity().z >
                    0
                      ? -1
                      : 1
                })
